...
def get_prompt(resources: List[Resource]) -> str:
    return f'''From now on, focus on deciding which URLs to load based on the ongoing conversation. By default, no URLs need to be loaded unless the user asks for specific information about a given URL.
